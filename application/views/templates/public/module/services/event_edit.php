...
if(!empty($eventData))
{
    ...
    $current_loc = $eventData->{User_event_model::_CURRENT_LOCATION};
        ...
        <div clas="col-md-12">
            ...
            <div class="form-group"> 
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <img src="<?php echo base_url('assets/uploads/data_document')."/".$image;?>" class="img-thumbnail pull-right" width="100px" height="100px" />
                        </div>
                        <div class="col-md-10">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="text" name="pct_price" id="pct_price" class="form-control" value="<?php echo $pctPrice; ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <input type="checkbox" name="has_date_time" data-toggle="toggle" <?php echo ($hasExpiryDate == '1' ? 'checked' : '');?>>
            ...
            <div class="form-group" >
                <div class="col-md-12">
                    ...
                    <label style="color: #FFF;">Current</label>                   
                    <input type="checkbox" id="curr" name="current_location" data-toggle="toggle" <?php echo ($current_loc == '1' ? 'checked' : '');?>/>
                    <input type="text" name="location" class="form-control" placeholder="Enter your location here" value="<?php echo $location; ?>" id="location" <?php echo ($current_loc == '0' ? 'readonly' : '');?>/>
                </div>
                <div class="clearfix"></div>
            </div>
            <div class="form-group">
                <div class="col-md-12">
                    ...
                    <input type="text" id="address" name="address" class="form-control" <?php echo ($current_loc == '0' ? 'readonly' : '');?>/>
                </div>
                <div class="clearfix"></div>
            </div>
            ...
            <div class="form-group">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <input type="text" class="form-control" name="kms-range" id="kms-range" value="<?php echo $offerRange; ?>">
                        </div>
...
$('input[type="text"][name="price"]').on('keyup', convert);
...
function convert()
{
    var conversion = $('select[name="price_currency"]').find(':selected').data('rate');
    var pct = $('input[type="text"][name="price"]').val();
    converted = parseFloat(pct) / parseFloat(conversion);
    $('input[type="text"][name="pct_price"]').val(converted);
}
