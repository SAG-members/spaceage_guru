...
<div class="quesmain">
	<div class="idealsteps-container">
		...
		<script>
		alert("RPQ Updated Successfully");
		</script>
		<?php endif;?> 
		<form id="rpq_reg" method="post" action="<?php echo base_url('profile/update-rpq-ios')?>" novalidate autocomplete="off" class="idealforms">
...
{	
	...
	var newForm = jQuery('<form>', {
        'action': '<?php echo base_url();?>' + 'profile/update-rpq-ios', 
        'target': '_top',
        'method':'post'	
    }).append(jQuery('<input>', {
