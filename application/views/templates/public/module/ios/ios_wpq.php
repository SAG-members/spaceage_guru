...
<div class="quesmain">
	<div class="idealsteps-container"> 
		...
		<script>
		alert("WPQ Updated Successfully");
		</script>
		<?php endif;?> 
		<form id="profile_reg" method="post" action="<?php echo base_url('profile/update-wpq-ios')?>" novalidate autocomplete="off" class="idealforms">
...
{	
	...
	var newForm = jQuery('<form>', {
        'action': '<?php echo base_url();?>' + 'profile/update-wpq-ios', 
        'target': '_top',
        'method':'post'	
    }).append(jQuery('<input>', {
