...
<!--                    <br>  -->
                    ...
                    <form action="<?php echo base_url('login')?>" method="post">
                        ...
                        <button><a href="<?php echo base_url('register');?>" style="color: #000000 !important;" class="">Register</a></button>
                    </form>
                    <?php else :?>
                               ...
                               <div class="row">
                                   <div class="col-md-12">
                                       <div class="input-group pull-right">
                                        <form id="searchSubmit" method="post" action="<?php echo base_url('user/dashboard');?>">
                                 <input type="text" name="wiki-search" class="form-control" placeholder="Write what you want" aria-describedby="basic-addon1" required="required">
                                   <span class="input-group-btn header-search">
                                   <button class="btn btn-secondary" name="btn-search" type="submit"><i class="fa fa-search" aria-hidden="true"></i></button>
                                  </span>
                              </form>
                                </div>
                                   </div>
