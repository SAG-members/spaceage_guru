...
<body style="margin:0; padding:0;">
	<div style="border:1px solid #E7E7E7; background-color:#087dc2; color:#FFF; text-align:center;"><p style="text-align: center;">
	...
	<div style="margin:0px; text-align:center;height:300px;padding:10px;">	
		<h3>You are invited to join santaclauseclub </h3>	
		<p>

		<b>Hello, <?php echo $email;?></b><br/><br/>
		You have received a invitation to join santaclauseclub, Please click on the button below to join<br />
		<br /><br />
