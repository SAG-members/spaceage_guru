...
class Paypal 
{
	...
	# IPN Log Path
	private $paypalIPNLogPath = '';
	private $logIPNLog = TRUE; 
	
	# Paypal Buttons
	private $paypalBtnPath = 'buttons';
			
	private $paypalURL;
	
	const _CURRENCY_CODE = 'EUR';
	const _TEST_URL = 'https://www.sandbox.paypal.com/cgi-bin/webscr';
	const _LIVE_URL = 'https://www.paypal.com/cgi-bin/webscr';
	...
	public function __construct()
	{
		...
		$sanbox = $this->isSandBox;
		$this->paypalURL = ($sanbox == TRUE)?static::_TEST_URL:static::_LIVE_URL;
                
		$this->lastError = '';
		$this->ipnResponse = '';

		$this->ipn_log_file = $this->ipnLogFile;
		$this->ipn_log = $this->ipnLog; 
		
		$this->button_path = $this->paypalBtnPath;
